...
from .multi_policies import BasePolicy, get_policy_from_name,register_policy
...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        if isinstance(policy, str) and policy_base is not None:
            register_policy(policy,policy_base)
        ...
        if env is not None:
            ...
            #print("observation_space is:",env.observation_space)
            #decode state
    ...
    def _setup_learn(
        ...
        if reset_num_timesteps or self._last_obs is None:
            ...
            self._last_obs = np.array([lxc_new_obs])
            print("self.env.num_envs is:",self.env.num_envs)
    ...
    def load(
        ...
        **kwargs,
        ...
        model = cls(
            ...
            env=env,
            device=device,
            lxc_stock_number = data["lxc_stock_number"],
            all_stock_number=data["all_stock_number"],
